...
function dialog::show(id, ...){
	switch(id){
		...
		case 6: create(6, "Laga 12 szt. z³.", "Zardzewia³y topór 110 szt. z³.", "Nó¿ na wilki 170 szt. z³.", "Zardzewia³y miecz dwurêczny 800 szt. z³", "Dobry krótki miecz 1200 szt. z³", "Mia¿d¿ydeska 9500 szt. z³.", "Kordelas 10000 szt. z³.", "Opuœæ"); break;
		...
		case 13: create(13, "Lekki pancerz najemnika 650 szt. z³.", "Œredni pancerz najemnika 11000 szt. z³.", "Ciê¿ki pancerz najemnika 17000 szt. z³.", "Opuœæ"); break;
	}
