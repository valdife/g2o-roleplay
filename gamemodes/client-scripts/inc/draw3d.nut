...
function draw3dInit(){
  ...
  draw3dCreate(12659, 998, 3246, "Spotykasz handlarza ¿ywnoœci¹ ((/buy))", 184, 129, 238);
	draw3dCreate(72117, 3348, -8849, "Spotykasz handlarza ¿ywnoœci¹ ((/buy))", 184, 129, 238);
  ...
  draw3dCreate(12358, 998, -1804, "Wygl¹da na to, ¿e mo¿na tu zarobiæ ((/work))", 184, 129, 238);
	draw3dCreate(71361, 3264, -10646, "Wygl¹da na to, ¿e mo¿na tu zarobiæ ((/work))", 184, 129, 238);
  ...
  //roulette
  draw3dCreate(1368, 5, -538, "Na stole znajduje siê prowizoryczna wersja ruletki ((/roulette))", 184, 129, 238);
	draw3dCreate(72010, 3332, -13008, "Na stole znajduje siê prowizoryczna wersja ruletki ((/roulette))", 184, 129, 238);
  ...
  draw3dCreate(8720, 314, 1486, "Lokalni pijacy zak³adaj¹ siê o to, kto wypije wiêcej Lou za 2 szt. z³. ((/drunk))", 184, 129, 238);
	draw3dCreate(72512, 3339, -9390, "Lokalni pijacy zak³adaj¹ siê o to, kto wypije wiêcej Lou za 2 szt. z³. ((/drunk))", 184, 129, 238);
